...
if (isset($_POST['register'])) {
    ...
    if (empty($fullname) || empty($email) || empty($password) || empty($contactno)) {
        ...
        VALUES('$fullname', '$email', '$hashed_password', '$contactno', '$status')");
...
if (isset($_POST['submit'])) {
    ...
    if (empty($username) || empty($password)) {
        ...
        $ret = mysqli_query($bd, "SELECT * FROM users WHERE userEmail='$username'");
        ...
        if ($num > 0 && password_verify($password, $num['password'])) {
            ...
            $status = 1;
            mysqli_query($bd, "INSERT INTO userlog(uid,username,userip,status) VALUES('" . $_SESSION['id'] . "', '$username', '$uip', '$status')");
            ...
            $uip = $_SERVER['REMOTE_ADDR'];
            $status = 0;
            mysqli_query($bd, "INSERT INTO userlog(username,userip,status) VALUES('$username', '$uip', '$status')");
...
.input-field:focus {
    border: 2px solid #fff; /* Visible border on focus */
    outline: none;
}

.input-field:hover, .input-field:focus {
    background: rgba(255, 255, 255, 0.4); /* Slightly change background on hover/focus */
}
...
<body>
 ...
 <div class="wrapper">
    <nav class="nav">
        <div class="nav-logo">
            <p>COMPLIANT MANAGEMENT SYSTEM  .</p>
        </div>
        <div class="nav-menu" id="navMenu">
            <ul>
                ...
                <li><a href="http://localhost/Complaint%20Management%20System/Complaint%20Management%20System/admin/index.php"class="link">Admin</a></li>
    ...
    <div class="two">
        ...
        <div class="register-container" id="register">
          ...
          <i class="bx bx-envelope"></i>
                ...
                <div class="input-box">
                    <input type="text" class="input-field" name="contactno" placeholder="Contact Number" required>

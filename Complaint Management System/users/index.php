...
body{
    background: url("assets/img/ui-sam.jpg");
...
<body>
 <div class="wrapper">
    <nav class="nav">
        ...
        <div class="nav-menu" id="navMenu">
            <ul>
                ...
                <li><a href="http://localhost/Complaint%20Management%20System/Complaint%20Management%20System/users/registration.php" class="link">Blog</a></li>
    ...
    <script>
        // Add your JavaScript here for toggling login/register
    </script>
</body>
</html>
